...
public partial class NorthwndContext : DbContext
{
    ...
    #region parametresiz kurucu metot
    /*
Bu parametresiz kurucu metot, genellikle Code-First yaklaşımıyla kullanılır. Bu durumda, DbContext, bir bağlamın varsayılan yapılandırma seçenekleriyle otomatik olarak yapılandırılır. Örneğin, varsayılan bağlantı dizesi ve diğer bazı özellikler, DbContext'in içinde belirlenen varsayılan değerlerle ayarlanır.
*/ 
    #endregion
    ...
    #region Parametreli kurucu metot
    /*
Bu parametreli kurucu metot, DbContextOptions tipinde bir parametre alır. Bu sayede, DbContext'in nasıl yapılandırılacağını belirlemek için dışarıdan gelen yapılandırma seçeneklerini kullanabilirsiniz. Bu genellikle daha esnek bir yaklaşımdır ve özellikle Dependency Injection kullanırken faydalıdır. Bu sayede, DbContext'in yapılandırması uygulama başlangıcında dışarıdan enjekte edilen yapılandırma seçeneklerine göre değiştirilebilir.

Özetle, parametresiz kurucu metot otomatik yapılandırma için kullanılırken, parametreli kurucu metot daha fazla özelleştirme ve dışarıdan gelen yapılandırma seçeneklerini kullanma imkanı sağlar. Hangi kurucu metodu kullanacağınız, uygulama ihtiyaçlarına ve tasarım tercihlerinize bağlıdır.
*/ 
    #endregion
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=localhost\\SQLEXPRESS;database=NORTHWND;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PersonelId).HasName("PK__Staff__0F0C5731F1874574");

            entity.Property(e => e.PersonelName).HasMaxLength(50);
